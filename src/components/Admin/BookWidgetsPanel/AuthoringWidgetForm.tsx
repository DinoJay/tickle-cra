...
interface AuthoringWidgetFormProps {
  widget: any;
  baseURL: string;
}

const AuthoringWidgetForm: React.FC<AuthoringWidgetFormProps> = props => {
  const { widget, baseURL } = props;
  const formName: string = uuid();
  const iframeName: string = uuid();
    ...
    <>
      ...
      >
        ...
        <input
          ...
          value={widget.content_item_return_url}
        />
        <input
          type="hidden"
