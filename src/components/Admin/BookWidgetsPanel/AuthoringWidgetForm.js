...
const AuthoringWidgetForm = props => {
    const { widget, baseURL } = props;
    const formName = uuid();
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { action: baseURL, method: "POST", encType: "application/x-www-form-urlencoded", target: iframeName, name: formName },
            ...
            React.createElement("input", { type: "hidden", id: "content_item_return_url", name: "content_item_return_url", value: widget.content_item_return_url }),
        ...
        React.createElement("iframe", { sandbox: "allow-same-origin allow-scripts allow-popups allow-forms", title: iframeName, width: "100%", height: "500", name: iframeName, id: iframeName })));
};
export default AuthoringWidgetForm;
