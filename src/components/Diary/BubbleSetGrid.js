...
const Grid = props => {
    ...
    return (React.createElement("div", { ref: ref, className: "relative flex flex-wrap justify-center items-start" }, cards.map((d, i) => (React.createElement(PreviewCard, { key: d.id, onClick: () => onClick(d.id), className: "m-6", style: {
...
const OneBubbleSet = props => {
    ...
    return (React.createElement("svg", { className: "pointer-events-none absolute z-20 w-full overflow-visible" },
...
const BubbleSetsWrapper = props => {
    const { open, onClick, style, authUser: { uid }, locs, cards, onCardClick } = props;
    ...
    return (React.createElement("div", { className: "mx-1 overflow-y-auto relative " },
        React.createElement("div", { className: "text-base mb-6 flex" },
            React.createElement("div", { className: "flex mr-2 text-lg mt-1 ml-1" },
                React.createElement("button", { className: "flex flex-col justify-start", type: "button", onClick: () => setSize(size - 1) },
                    React.createElement(Minus, { className: "mt-2" })),
                React.createElement("button", { className: "flex flex-col justify-start", type: "button", onClick: () => setSize(size + 1) },
                    React.createElement(Plus, { className: "mt-2" }))),
            React.createElement(SelectTags, { className: "bg-white flex-grow mt-1 mx-1", values: [
        ...
        React.createElement(Grid, { onClick: onCardClick, cards: filteredCards, onRendered: setDomNodes, size: size })));
};
