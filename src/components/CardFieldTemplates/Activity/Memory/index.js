...
import MemoryAuthor from './MemoryAuthor';
...
export const ModalContent = props => {
    ...
    // toggleUserview,
    // disabled = false
    return activityUserview ? (React.createElement(MemoryView, { disabled: false, id: id, authUser: authUser, addActivitySubmission: addActivitySubmission, activitySubmission: activitySubmission, toggleUserview: toggleUserview, match: match, onClose: onClose, activity: activity, onSubmit: onSubmit })) : (React.createElement(MemoryAuthor, Object.assign({}, props, { toggleUserview: toggleUserview, onChange: onChange, activity: activity, key: "1" })));
};
// import ActivityDB from '~/firebase/db/activity_db';
export const View = MemoryView;
