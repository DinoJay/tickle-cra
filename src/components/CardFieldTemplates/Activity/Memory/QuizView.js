...
const QuizView = props => {
    ...
    return (React.createElement("div", { className: "flex flex-col flex-grow bg-white overflow-y-auto" },
        React.createElement(TabSlider, { className: "flex-grow flex flex-col", tabClassName: "flex-grow", draggable: false, visibleIndex: visibleIndex }, questions.map((q, i) => (React.createElement("div", { className: "flex flex-col flex-grow overflow-y-hidden" },
            ...
            lastQ(i) && submitted && (React.createElement(QuizResults, Object.assign({}, props, { className: "mt-auto" }, getResults()))),
