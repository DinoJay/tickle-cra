...
const WidgetForm = props => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("form", { action: baseURL, method: "POST", encType: "application/x-www-form-urlencoded", target: iframeName, name: formName },
            ...
            React.createElement("input", { type: "hidden", id: "lis_result_sourcedid", name: "lis_result_sourcedid", value: widget.lis_result_sourcedid }),
            React.createElement("input", { type: "hidden", id: "lis_outcome_service_url", name: "lis_outcome_service_url", value: widget.lis_outcome_service_url }),
            ...
            React.createElement("input", { type: "hidden", id: "custom_initial_submit", name: "custom_initial_submit", value: widget.custom_initial_submit }),
            React.createElement("input", { type: "hidden", value: "Press to launch widget" })),
        React.createElement("iframe", { title: iframeName, width: size.width, height: size.height, name: iframeName })));
};
