...
const DefaultMarkerElement = props => {
    const { color = theme.colors.yellow[500] } = props;
    return (React.createElement("svg", Object.assign({ height: "41px", width: "27px", viewBox: "0 0 27 41" }, props),
...
export default DefaultMarkerElement;
