import { RECEIVE_USERS, RECEIVE_ALL_ENVS, RECEIVE_ALL_EVENTS, 
// GET_CARDS,
SELECT_USER, INSERT_USER_INTO_ENV, DELETE_USER_FROM_ENV, ADD_ENV, UPDATE_ENV, 
// SUBMIT_CHALLENGE_REVIEW,
SELECT_USERS_BY_ENV, USER_REGISTRATION_ERROR, ADD_USER, UPDATE_USER_INFO, REMOVE_USER, DELETE_ENV } from './types';
const INITIAL_STATE = {
    users: [],
    selectedUserId: null,
    envs: [],
    ...
    switch (action.type) {
        ...
        case ADD_ENV: {
            ...
            if (envIds.includes(env.id)) {
                const changedEnvs = state.envs.map(e => e.id === env.id ? { ...e, ...env } : e);
